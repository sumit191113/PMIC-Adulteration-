...
import { User, Calendar, Tag, Search, X, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="px-4 py-6 max-w-2xl mx-auto animate-slide-up pb-20">
      <div className="mb-6 flex justify-between items-start">
        <div>
          <h2 className="text-2xl font-bold text-slate-800">My Findings</h2>
          <p className="text-slate-500 text-sm">Locally saved adulteration reports.</p>
        </div>
        <div className="px-2 py-1 rounded-md text-[10px] font-bold uppercase tracking-wider flex items-center gap-1 border bg-primary-50 text-primary-700 border-primary-200">
      ...
      {loading ? (
        <div className="text-center py-20">
            ...
            <p className="text-slate-400">Loading your findings...</p>
        </div>
      ) : reports.length === 0 ? (
        <div className="text-center py-20 bg-white rounded-3xl border-2 border-dashed border-slate-200">
          ...
          <p className="text-slate-400 max-w-xs mx-auto mt-2">
            Submit a report to see your findings listed here.
          </p>
        </div>
      ) : (
